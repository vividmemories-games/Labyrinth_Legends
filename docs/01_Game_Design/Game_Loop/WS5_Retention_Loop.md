...
```mermaid
flowchart LR
  W1[Week 1 — Learning] --> W2[Week 2 — Exploring]
  W2 --> W3[Week 3 — Mastering]
  W3 --> M2[Month 2 — Completion]
  M2 --> M6[Month 6+ — New handcrafted content]
```
...
```mermaid
flowchart TB
  WS1[WS1 Core — every few seconds] --> WS2[WS2 Session — one sitting]
  WS2 --> WS3[WS3 Progression — weeks]
  WS3 --> WS4[WS4 Completion — milestones]
  WS4 --> WS5[WS5 Retention — months]
  WS5 -.->|feeds| WS1
```
